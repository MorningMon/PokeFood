...
public class CarbonizerGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CarbonizerGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PokefoodModMenus.CARBONIZER_GUI.get(), id);

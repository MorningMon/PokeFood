...
public class KegGUIScreen extends AbstractContainerScreen<KegGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("pokefood:textures/screens/keg_gui.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("pokefood:textures/screens/keg_0.png"));
